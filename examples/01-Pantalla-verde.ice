{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "7f39a13b-525f-405d-a8cd-189f99c006c1",
          "type": "basic.output",
          "data": {
            "name": "RED",
            "pins": [
        ...
        {
          "id": "70c925d7-e4b9-407d-a04d-6310c42a8052",
          "type": "basic.output",
          "data": {
            "name": "GREEN",
            "pins": [
        ...
        {
          "id": "c5109ffa-51fc-4f72-8a87-269c0aa7c78a",
          "type": "basic.output",
          "data": {
            "name": "BLUE",
            "pins": [
        ...
        {
          "id": "77907203-bfd8-4f8d-aab8-697157cd1982",
          "type": "3a44d47507cb376c1270330adcdc741ee5997f51",
          "position": {
            "x": 1128,
            "y": 648
          },
        ...
        {
          "id": "af6dade2-4e10-44d0-adf8-8a9f4a8630f6",
          "type": "basic.info",
          "data": {
            "info": "**Color de la señal de Vídeo**",
            "readonly": true
          },
          "position": {
            "x": 1072,
        ...
        {
          "id": "7aeadc2f-d502-42bf-bc66-cd832c002eb1",
          "type": "basic.info",
          "data": {
            "info": "## Señales de sincronización\n\n**VGA SYNC** Genera las señales de sincronización\nnecesarias para la VGA",
            "readonly": true
          },
          "position": {
            "x": 768,
        ...
        {
          "id": "5357a34a-dcfb-48bc-94fa-144c87b15c6d",
          "type": "basic.info",
          "data": {
            "info": "**VGA RGB** es el componente que toma la señal de vídeo\ny activa los canales RGB correspondientes para ver los\ngráficos en el color seleccionado",
            "readonly": true
          },
          "position": {
            "x": 1248,
        ...
        {
          "id": "d3609797-53bb-4269-9b17-9109ef32750f",
          "type": "basic.info",
          "data": {
            "info": "Señales que llegan físicamente al\n**conector de la VGA**. Solo son necesarias 5\nseñales: **R**,**G**,**B**,**Horizontal Sync** y\n**Vertical Sync**",
            "readonly": true
          },
          "position": {
            "x": 1792,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "7f39a13b-525f-405d-a8cd-189f99c006c1",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "70c925d7-e4b9-407d-a04d-6310c42a8052",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "c5109ffa-51fc-4f72-8a87-269c0aa7c78a",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "77907203-bfd8-4f8d-aab8-697157cd1982",
        ...
        "graph": {
          "blocks": [
            ...
            },
            {
              ...
              "type": "basic.info",
              "data": {
                "info": "Constante de 3 bits para el **COLOR VERDE**",
                "readonly": false
              },
              "position": {
                "x": 1080,
