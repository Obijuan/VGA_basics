  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "be9e3cd1-8a9f-4f69-ad56-e54362ad9c50",
          "type": "basic.output",
          "data": {
            "name": "HS",
            "pins": [
        ...
        {
          "id": "29d19e91-509a-4ddb-b99f-239ca2203e2c",
          "type": "basic.output",
          "data": {
            "name": "VS",
            "pins": [
        ...
        {
          "id": "143e5478-cfde-47fa-b78a-cf772d5a4721",
        ...
        {
          "id": "0af5cd12-f95d-499e-aa9f-1561e9d72f91",
          "type": "21cfcc19a4ad14c5fb5e8cfebd018ec356fe7542",
          "position": {
            "x": 576,
            "y": 240
        ...
        {
          "id": "e9d6fe95-a48e-4a6b-9f2b-7bcd3a07d839",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "8c950bf3-2ab1-4bb9-965f-311fe823dc52",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "a0dce195-9d30-465c-8f40-40a96f723eb1",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "d1545c3c-19b1-490a-aedc-d80916a8369a",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "de7f3b46-c0ee-4f1d-a296-3f4893754fcf",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "01031b15-8336-4882-87c3-d4ce25b02af3",
        ...
        {
          "id": "724d9870-4fac-4659-a2bb-c3babcf1d0c5",
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 2: Fondo verde\n\nMismo ejemplo que el 1: poner el fondo verde  \nImplementado usando el componente **VGA SYNC**\n",
            "readonly": true
          },
          "position": {
            "x": 56,
        ...
        {
          "id": "f84c4182-8e69-4a6c-8dc3-e14080e7008a",
          "type": "basic.info",
          "data": {
            "info": "El video activo sólo se envía al **canal Verde**\n\nLos demas canales están a 0\n(apagados)",
            "readonly": true
          },
          "position": {
            "x": 72,
      ...
      "wires": [
        {
          "source": {
            "block": "143e5478-cfde-47fa-b78a-cf772d5a4721",
        ...
        {
          "source": {
            "block": "0af5cd12-f95d-499e-aa9f-1561e9d72f91",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
        ...
        {
          "source": {
            "block": "01031b15-8336-4882-87c3-d4ce25b02af3",
        ...
        },
        {
          ...
          "target": {
            "block": "29d19e91-509a-4ddb-b99f-239ca2203e2c",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "be9e3cd1-8a9f-4f69-ad56-e54362ad9c50",
            "port": "in"
          },
          "vertices": [
            {
